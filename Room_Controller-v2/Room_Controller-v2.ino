...
void loop() {
  ...
  if (serialData.length()>0){
      if (serialData == "HB"){
          sendReply("Room Conroller Ok.");
      }
      else if(serialData == "GET-PA1VOLT"){
          sendReply((String)getPA1Voltage());
      }
      else if(serialData == "GET-PA1CURRENT"){
          sendReply((String)getPA1Current());
      }
      else if(serialData == "GET-PA1ALL"){
          ;
      }
      else if(serialData == "GET-PA2VOLT"){
          sendReply((String)getPA2Voltage());
      }
      else if(serialData == "GET-PA2CURRENT"){
          sendReply((String)getPA2Current());
      }
      else if(serialData == "GET-PA2ALL"){
          ;
      }
      else if(serialData == "GET-PA3VOLT"){
          sendReply((String)getPA3Voltage());
      }
      else if(serialData == "GET-PA3CURRENT"){
          sendReply((String)getPA3Current());
      }
      else if(serialData == "GET-PA3ALL"){
          ;
      }
      else if(serialData == "ON-LIGHT1"){
          if (OPERLight1("ON")){
              sendReply("LIGHT1 is ON.");
          }
          else{
              sendReply("ERROR turning ON LIGHT1.");
          }
      }
      else if(serialData == "OFF-LIGHT1"){
          if (!OPERLight1("OFF")){
              sendReply("LIGHT1 is OFF.");
          }
          else{
              sendReply("ERROR turning OFF LIGHT1.");
          }
      }
      else if(serialData == "TOG-LIGHT1"){
          bool TOGGLEResult = OPERLight1("TOG");
          if (TOGGLEResult){
              sendReply("LIGHT1 is ON.");
          }
          else{
